package com.billy.android.soso.framwork.net.parser;


import com.billy.android.soso.framwork.net.bean.ResultData;
...
@Parser(name="Result", wrappers = {})
public class ResultDataParser<T>  extends TypeParser<T> {
    /**
     ...
     */
    public ResultDataParser(Type type) {
        super(type);
    }
    ...
    public T onParse(@NotNull okhttp3.Response response) throws IOException {
        ResultData<T> data = Converter.convertTo(response, ResultData.class, types);
