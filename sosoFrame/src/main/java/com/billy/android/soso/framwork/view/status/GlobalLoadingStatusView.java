...
import static com.billy.android.soso.framwork.net.exception.ExceptionHelper.isNetworkConnected;
import static com.billy.android.soso.framwork.view.status.Gloading.STATUS_EMPTY_DATA;
import static com.billy.android.soso.framwork.view.status.Gloading.STATUS_LOADING;
import static com.billy.android.soso.framwork.view.status.Gloading.STATUS_LOAD_FAILED;
import static com.billy.android.soso.framwork.view.status.Gloading.STATUS_LOAD_SUCCESS;
    ...
    public void setStatus(int status) {
        ...
        switch (status) {
            ...
            case STATUS_LOAD_FAILED:
                ...
                Boolean networkConn = Gloading.isNetworkConnected(getContext());
